...
import se.sics.example.nat.node.serializers.NodeSerializerSetup;
...
public class NodeLauncher extends ComponentDefinition {
    ...
    private final Component nodeHost;
    ...
    public NodeLauncher() {
        ...
        nodeHost = create(NodeHostComp.class, new NodeHostInit(config, systemHooks));
    ...
    public static void start() {
        ...
        Kompics.createAndStart(NodeLauncher.class, Runtime.getRuntime().availableProcessors(), 20); // Yes 20 is totally arbitrary
    }
