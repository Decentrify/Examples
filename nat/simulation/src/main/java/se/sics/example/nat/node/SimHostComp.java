 ...
 */
public class SimHostComp extends ComponentDefinition {
    ...
    public static class SimHostInit extends Init<SimHostComp> {
        ...
        public SimHostInit(KConfigCore config, SystemHookSetup systemHooks, Class hostClass, Init hostInit) {
